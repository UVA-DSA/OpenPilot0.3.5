...
class AlertManager(object):
  alerts = {
    ...
    "fcw":                   alert("Take Control Immediately", "Forward Collision Warning",   ET.WARNING,           None,            None,            .1, .1, .1),
    # car errors
  ...
  def process_alerts(self, cur_time):
    if self.alertPresent():
      ...
      print "================="   # included this line for clear visulation of alerts in cmd -- Hasnat
