  ...
  def evaluate(self):
    ...
    while plant.current_time() < self.duration:
      while buttons_sorted and plant.current_time() >= buttons_sorted[0][1]:
        ...
        #print "current button changed to", current_button   # commented by Hasnat
      ...
      distance, speed, acceleration, distance_lead, brake, gas, steer_torque, live100 = plant.step(speed_lead, current_button, grade, self.frameIdx)   # self.frameIdx added by Hasnat
      if live100:
